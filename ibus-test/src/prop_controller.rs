...
use ibus_sys::{
    core::to_gboolean,
    engine::{ibus_engine_register_properties, IBusEngine},
    glib::{g_object_ref_sink, gchar, gpointer},
    prop_list::{ibus_prop_list_append, ibus_prop_list_new, IBusPropList},
    property::{
        ibus_property_new, ibus_property_set_sub_props, IBusPropState_PROP_STATE_CHECKED,
        IBusPropState_PROP_STATE_UNCHECKED, IBusPropType_PROP_TYPE_MENU,
        ...
        *mut IBusPropList,
        ...
        unsafe {
            ...
            let prop = g_object_ref_sink(ibus_property_new(
                ...
                to_gboolean(true),
                to_gboolean(true),
                if INPUT_MODE_TELEX.mode == init_input_mode.mode {
