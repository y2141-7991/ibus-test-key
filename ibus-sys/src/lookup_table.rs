...
impl IBusLookupTable {
    ...
    pub fn get_number_candidates(&self) -> guint {
    ...
    pub fn append_candidate(&mut self, text: *mut IBusText) {
        unsafe {
            ibus_lookup_table_append_candidate(self as *mut _, text as *mut _);
        }
    }
}
...
extern "C" {
    ...
    pub fn ibus_lookup_table_get_number_of_candidates(tabel: *const IBusLookupTable) -> guint;
